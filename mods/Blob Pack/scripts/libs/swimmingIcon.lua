...
local function IsAmphibious(pawn)
	...
	return pawnData and pawnData.Supermassive and pawnData.Flying and not flyingPilot
end
...
local function finalizeInit(self)	
	...
	function GetStatusTooltip(id)
		if	id == "flying"		and
			...
			return {"Titanic", "Titanic units cannot fall down holes and ignore liquids, turning them into solid ground."}
		end
